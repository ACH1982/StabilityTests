...
load('transfer_ACE10A_ACE11D_0DEG_off_5DEG_amp.mat');
load('freqDemandRam_ACE10A_ACE11D_0DEG_off_5DEG_amp.mat');
load('rangefreq_ACE10A_ACE11D_0DEG_off_5DEG_amp.mat');
load('timeStep.mat','timeStep');
% Estimate the open loop transfer function
transferCL = transfer_ACE10A_ACE11D_0DEG_off_5DEG_amp;
