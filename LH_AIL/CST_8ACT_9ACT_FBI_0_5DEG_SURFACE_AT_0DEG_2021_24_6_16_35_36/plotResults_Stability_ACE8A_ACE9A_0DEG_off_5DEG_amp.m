...
mag = abs(transferOL(rangefreq_ACE8A_ACE9A_0DEG_off_5DEG_amp));
phase = angle(transferOL(rangefreq_ACE8A_ACE9A_0DEG_off_5DEG_amp))*180/pi;
subplot(1,2,1)
margin(mag,phase,freqDemandRam_ACE8A_ACE9A_0DEG_off_5DEG_amp(rangefreq_ACE8A_ACE9A_0DEG_off_5DEG_amp)*2*pi);
subplot(1,2,2)
yyaxis right
semilogx(freqDemandRam_ACE8A_ACE9A_0DEG_off_5DEG_amp(rangefreq_ACE8A_ACE9A_0DEG_off_5DEG_amp),...
    20*log10(abs(transferOL(rangefreq_ACE8A_ACE9A_0DEG_off_5DEG_amp))))
yyaxis left
semilogx(freqDemandRam_ACE8A_ACE9A_0DEG_off_5DEG_amp(rangefreq_ACE8A_ACE9A_0DEG_off_5DEG_amp),...
     angle(transferOL(rangefreq_ACE8A_ACE9A_0DEG_off_5DEG_amp))*180/pi),grid
